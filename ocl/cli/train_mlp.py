...
def train(config: TrainingConfig):
    ...
    model = build_model_from_config(config,checkpoint_path)

    # # freeze all parameters
    for param in model.parameters():
        param.requires_grad = False

    # # unfreeze slot decoder
    for param in model.models.object_decoder.slot_decoder.parameters():
    ...
    trainer: pl.Trainer = hydra_zen.instantiate(config.trainer, callbacks=callbacks, logger=logger, _convert_="all")
