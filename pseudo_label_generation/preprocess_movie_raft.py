...
def main(args):
    ...
    base_of_output_dir = os.path.join(args.base_dir, f"movi_e_of_{args.optical_threshold}_corner_{args.required_corners}_{args.rgb_path}")
    if args.compute_flow:
        run_inference.process_images(base_input_dir,args.rgb_path,args.model_path,args.reverse_flag,args.image_res)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default='raft/checkpoints/raft-things.pth', help="Path of pretrained raft weights")
